...
@Component({
  selector: 'app-product-purchase-supplier',
  templateUrl: './product-purchase-supplier.component.html',
  styleUrls: ['./product-purchase-supplier.component.scss']
})
export class ProductPurchaseSupplierComponent {
columns: any[] = [
    { name: "product-history.supplierName", field: "customerName" },
...
@Input()  productId:any;
  ...
  private getList () 
  {
    this.baseService.Post('Product', 'GetPurchaseProductBySupplier', this.baseSearch).subscribe
    ( res => 
      {
