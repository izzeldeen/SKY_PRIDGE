...
@Component({
  selector: 'app-customer-history-installment',
  templateUrl: './customer-history-installment.component.html',
  styleUrls: ['./customer-history-installment.component.scss']
})
export class CustomerHistoryInstallmentComponent {
